...
|[Neo](./Neo/Production%20Files/)|+Filament Sensor<br>+RGB LED<br>+LED connector<br>+Jump Solder Diode bypass<br>merged XES/FS|Almost an ERCF<br>drop-in alternative|14+2 pins|24v<br>5v LED|RGB|Flisher|
